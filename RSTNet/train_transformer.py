...
if __name__ == '__main__':
    ...
    parser.add_argument('--features_path', type=str, default='../data/train.hdf5')
    parser.add_argument('--annotation_folder', type=str, default='../data/')

    parser.add_argument('--dir_to_save_model', type=str, default='/data2/samsung_IC/RSTNet/saved_transformer_models_m2/')
    parser.add_argument('--logs_folder', type=str, default='/data2/samsung_IC/RSTNet/transformer_tensorboard_logs')
    
    parser.add_argument('--xe_least', type=int, default=20)
    parser.add_argument('--xe_most', type=int, default=30)
    parser.add_argument('--refine_epoch_rl', type=int, default=5)
    ...
    image_field = ImageDetectionsField(train_detections_path='../data/train.hdf5',
                                       valid_detections_path='../data/valid.hdf5', 
    ...
    # Create the dataset
    dataset = COCO(image_field, text_field, '', args.annotation_folder, args.annotation_folder)
    ...
    for e in range(start_epoch, start_epoch + 100):
        ...
        if use_rl:
            copyfile(os.path.join(args.dir_to_save_model, '%s_last.pth' % args.exp_name), os.path.join(args.dir_to_save_model, 'rl' + str(e) + '.pth'))
