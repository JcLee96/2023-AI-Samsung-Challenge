...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation_folder', type=str, default='../dataset')
    ...
    for e in range(start_epoch, start_epoch + 100):
        ...
        dataloader_test = DataLoader(test_dataset, batch_size=args.batch_size, num_workers=args.workers)
