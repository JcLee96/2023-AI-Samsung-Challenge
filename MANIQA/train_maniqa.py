...
from models.maniqa import MANIQA, MANIQA3Stages
...
def eval_epoch(config, epoch, net, criterion, test_loader):
    with torch.no_grad():
        ...
        print('Epoch:{} ===== loss:{:.4} ===== SRCC:{:.4} ===== PLCC:{:.4}'.format(epoch + 1, np.mean(losses), rho_s,
                                                                                 rho_p))
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # samsung
        "samsung_train_path": "../samsung_LK99/dataset/train_mos.csv",
        "samsung_valid_path": "../samsung_LK99/dataset/valid_mos.csv",
        ...
        "model_name": "samsung",
        "type_name": "samsung",
        "ckpt_path": "/data2/samsung_IC/MANIQA3stages/",               # directory for saving checkpoint
        "log_path": "./data2/samsung_IC/MANIQA3stages/log/",
        "log_file": ".log",
        "tensorboard_path": "/data2/samsung_IC/MANIQA3stages/tensorboard/"
    })
    ...
    if config.dataset_name == 'kadid10k':
        from data_name.kadid10k.kadid10k import Kadid10k
        ...
        from data_name.PIPAL22.pipal import PIPAL
        ...
        from data_name.koniq10k.koniq10k import Koniq10k
        ...
        Dataset = Koniq10k
    elif config.dataset_name == 'samsung':
    ...
    # model defination
    net = MANIQA3Stages(embed_dim=config.embed_dim, num_outputs=config.num_outputs, dim_mlp=config.dim_mlp,
    ...
    for epoch in range(0, config.n_epoch):
        ...
        wandb.log({"Train SRCC": rho_s, "Train PLCC": rho_p, "Epoch": epoch, "Trainloss": loss_val})
